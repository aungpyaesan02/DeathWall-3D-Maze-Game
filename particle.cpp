...
HRESULT InitParticle(void)
{
	...
	for(int nCntParticle = 0; nCntParticle < MAX_PARTICLE; nCntParticle++)
	{
		...
		g_aParticle[nCntParticle].playerpos = XMFLOAT3(0.0f, 0.0f, 0.0f);
...

	{
		for(int nCntParticle = 0; nCntParticle < MAX_PARTICLE; nCntParticle++)
		{
			if(g_aParticle[nCntParticle].bUse)
			{
				...
				if (g_aParticle[nCntParticle].pos.x < g_aParticle[nCntParticle].playerpos.x - BULLER_DISTANCE
					|| g_aParticle[nCntParticle].pos.x > g_aParticle[nCntParticle].playerpos.x + BULLER_DISTANCE
					|| g_aParticle[nCntParticle].pos.z < g_aParticle[nCntParticle].playerpos.z - BULLER_DISTANCE
					|| g_aParticle[nCntParticle].pos.z > g_aParticle[nCntParticle].playerpos.z + BULLER_DISTANCE)
				{
					g_aParticle[nCntParticle].bUse = FALSE;
					ReleaseShadow(g_aParticle[nCntParticle].nIdxShadow);
...
//int SetParticle2(XMFLOAT3 pos, XMFLOAT3 rot)
//{
//	int nIdxParticle = -1;
//
//	for (int nCntParticle = 0; nCntParticle < MAX_PARTICLE; nCntParticle++)
