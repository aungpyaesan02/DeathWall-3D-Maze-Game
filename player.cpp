...
// マクロ定義
//*****************************************************************************
#define	MODEL_PLAYER		"data/MODEL/spaceship02.obj"	// 読み込むモデル名
#define	MODEL_PLAYER_PARTS	"data/MODEL/gun.obj"			// 読み込むモデル名
...
#define PLAYER_PARTS_MAX	(3)								// プレイヤーのパーツの数
...
static INTERPOLATION_DATA move_tbl_right[] = {	// pos, rot, scl, frame
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(1.0f, 0.0f, 1.0f),      XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(XM_PI / 2, 0.0f, 0.0f), XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(1.0f, 1.0f, 1.0f),      XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(-1.0f, 0.0f, 1.0f),      XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(-XM_PI / 2, 0.0f, 0.0f), XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
	{ XMFLOAT3(20.0f, 15.0f, 0.0f), XMFLOAT3(-1.0f, 1.0f, 1.0f),      XMFLOAT3(1.0f, 1.0f, 1.0f), 60 },
...
HRESULT InitPlayer(void)
{
	...
	g_Player.HP = g_Player.HP_MAX = 500;
...
void UpdatePlayer(void)
{
	...
	if (GetKeyboardTrigger(DIK_SPACE))
	{
		...
		SetParticle(g_Player.pos, g_Player.rot, XMFLOAT4{ 1.0f,0.0f,0.0f,1.0f }, 10.0f, 10.0f, 400);
	...
	vx = XMVector3Cross(up, XMLoadFloat3(&g_Player.upVector)); // Zの軸(任意の軸)
	...
	if ((g_Player.pos.x < MAP_LEFT)) 		g_Player.pos.x = MAP_LEFT; //+
	
	if ((g_Player.pos.x > MAP_RIGHT))		g_Player.pos.x = MAP_RIGHT; //-

	if ((g_Player.pos.z > MAP_TOP))			g_Player.pos.z = MAP_TOP;

	if ((g_Player.pos.z < MAP_DOWN))		g_Player.pos.z = MAP_DOWN;
